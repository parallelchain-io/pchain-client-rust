...
/// Client with methods corresponding to fullnode RPC V1.
pub struct ClientV1 {
...
impl ClientV1 {
    ...
    pub async fn state(
    ...
    ) -> Result<pchain_types::rpc::StateResponseV1, HttpErrorResponse> { 
        ...
        let state_response: pchain_types::rpc::StateResponseV1 = pchain_types::rpc::StateResponseV1::deserialize(&raw_bytes)
        .map_err(|e| PChainClientError::new(e.to_string()))?;    
